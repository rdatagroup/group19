...
#filtering out confederations for 2017
...
CONMEBOL
#total perfomnce in Year 2017

data_sorted_2017<-ddply(data2,.(country_full),
                        summarize,sum2=sum(previous_points))
data_sorted_2017
#sort in descending order
desc <- data_sorted_2017[order(-data_sorted_2017$sum2), ]
desc
