...
#filtering out confederations for 2015
...
CONMEBOL
#total perfomnce in Year 2015

data_sorted_2015<-ddply(data2,.(country_full),
                        summarize,sum2=sum(previous_points))
data_sorted_2015
#sort in descending order
desc <- data_sorted_2015[order(-data_sorted_2015$sum2), ]
desc
