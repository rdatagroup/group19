...
#filtering out confederations for 2016
...
CONMEBOL
#total perfomnce in Year 2016

data_sorted_2016<-ddply(data2,.(country_full),
                        summarize,sum2=sum(previous_points))
data_sorted_2016
#sort in descending order
desc <- data_sorted_2016[order(-data_sorted_2016$sum2), ]
desc